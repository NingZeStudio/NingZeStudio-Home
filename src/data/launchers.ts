...
export const launchers: LauncherItem[] = [
  {
    ...
    shortName: 'ZL2',
    tagline: '现代化跨平台 Minecraft 启动器',
    description: '采用现代化技术栈与美观界面设计的跨平台启动器，深度内置 LogShare 一键日志上传与智能分析生态。',
  ...
  },
  {
    ...
    shortName: 'Axolotl',
    tagline: '轻量优雅的 Minecraft 启动器',
    description: '专为极致响应与极简体验打造的启动器，集成社区诊断生态，为玩家提供开箱即用的流畅游玩与报错反馈环境。',
  ...
  },
  {
    ...
    tagline: '专为嵌入式与便携设备优化的 Minecraft 启动器',
    description: '聚焦便携端与嵌入式 Linux 平台的轻量级启动器，内置错误捕捉机制，支持将运行时崩溃日志快速同步至 LogShare。',
    website: 'https://pil.nav4ai.net/',
    github: 'https://github.com/MrShellad/pilauncher',
    platforms: ['Linux', 'ARM', 'Android'],
  ...
  },
  {
    ...
    shortName: 'AMCL',
    tagline: '极简高效的 Minecraft 客户端工具',
    description: '体积轻巧、功能聚焦的 Minecraft 启动工具，深度打通日志生态，协助玩家与技术服主快速排查客户端闪退。',
